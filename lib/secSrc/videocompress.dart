...
class _CompressVideoScreenState extends State<CompressVideoScreen> {
  ...
  void selectVideo() async {
    ...
    setState(() async {
      ...
      loading = 'Y';
      imgSize =
          'Size: ${fileSizeInGB.toStringAsFixed(3)} GB or ${fileSizeInMB.toStringAsFixed(2)} MB or ${fileSizeInKB.toStringAsFixed(1)} KB';
                      ...
                      compressLoading == 'Y'
                          ...
                          : Column(
                              children: [
                                Row(
                                  children: [
                                    const Text('Video Quality level:'),
